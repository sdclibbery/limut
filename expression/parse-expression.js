...
define(function(require) {
  ...
  assert({"value":0,"_nextSegment":1,"_segmentPower":0}, evalParamFrame(p,ev(0,0),0))
  assert({"value":1,"_nextSegment":2,"_segmentPower":0}, evalParamFrame(p,ev(1,1),1))
  assert({"value":2,"_nextSegment":3,"_segmentPower":0}, evalParamFrame(p,ev(2,2),2))
  assert({"value":0,"_nextSegment":4,"_segmentPower":0}, evalParamFrame(p,ev(3,3),3))

  p = parseExpression('[0,2]l1@s')
  assert({"value":0,"_nextSegment":1,"_segmentPower":1}, evalParamFrame(p,ev(0,0),0))
  assert({"value":1,"_nextSegment":1,"_segmentPower":1}, evalParamFrame(p,ev(0,0),1/2))
  assert({"value":2,"_nextSegment":2,"_segmentPower":1}, evalParamFrame(p,ev(0,0),1))
  assert({"value":1,"_nextSegment":2,"_segmentPower":1}, evalParamFrame(p,ev(0,0),3/2))
  assert({"value":0,"_nextSegment":3,"_segmentPower":1}, evalParamFrame(p,ev(0,0),2))

  p = parseExpression('[0,2]s1@s')
  assert({"value":0,"_nextSegment":1,"_segmentPower":3}, evalParamFrame(p,ev(0,0),0))
  ...
  p = parseExpression("[0:^,1:^]t1@f")
  assert(0, evalParamFrame(p, evt(0,0,2), 0))
  assertApprox(1/4, evalParamFrame(p, evt(0,0,2), 1/2))
  assert(1, evalParamFrame(p, evt(0,0,2), 1))
  assertApprox(3/4, evalParamFrame(p, evt(0,0,2), 3/2))

  p = parseExpression("[0:^3:1,1:^3:1]t@f")
  assert(0, evalParamFrame(p, evt(0,0,2), 0))
  assertApprox(1/8, evalParamFrame(p, evt(0,0,2), 1/2))
  assert(1, evalParamFrame(p, evt(0,0,2), 1))
  assertApprox(7/8, evalParamFrame(p, evt(0,0,2), 3/2))
  ...
  p = parseExpression("[2]t*[1,0]e1@s")
  assert({"value":2,"_nextSegment":1,"_segmentPower":1}, evalParamFrame(p, ev(0,0,1), 0))
  assert({"value":1,"_nextSegment":1,"_segmentPower":1}, evalParamFrame(p, ev(0,0,1), 1/2))
  assert({"value":0,"_nextSegment":2,"_segmentPower":0}, evalParamFrame(p, ev(0,0,1), 1))

  p = parseExpression("[2,0,4,0]e1/4@s*[1:_,0]e1/2@s")
  ...
  p = parseExpression("[0,1]e1@s+[1:!,0]e1@s")
  ...
  p = parseExpression("[0,1]e1@s")
  assert({"value":0,"_nextSegment":1,"_segmentPower":1}, evalParamFrame(p, ev(0,0,1), 0))
  assert({"value":1,"_nextSegment":2,"_segmentPower":0}, evalParamFrame(p, ev(0,0,1), 1))
  assert(1, evalParamFrame(p, ev(0,0,1), 2))

  p = parseExpression("[[2:_,0]e1/2@s,0,[4:_,0]e1/2@s,0]e1/4@s")
  assert({"value":2,"_nextSegment":1/4,"_segmentPower":1}, evalParamFrame(p, ev(0,0,1), 0))
  assert({"value":1,"_nextSegment":1/4,"_segmentPower":1}, evalParamFrame(p, ev(0,0,1), 1/8))
  assert({"value":0,"_nextSegment":2/4,"_segmentPower":1}, evalParamFrame(p, ev(0,0,1), 2/8))
  assert({"value":2,"_nextSegment":2/4,"_segmentPower":1}, evalParamFrame(p, ev(0,0,1), 3/8))
  ...
  p = parseExpression("[[1:!,0]e1@s,1+[1:!,0]e1@s]e1@s")
  assert({"value":1,"_nextSegment":1,"_segmentPower":2}, evalParamFrame(p, ev(0,0,1), 0))
  assert({"value":0.5183156388887342,"_nextSegment":1,"_segmentPower":2}, evalParamFrame(p, ev(0,0,1), 1/2))
  assert({"value":1,"_nextSegment":2,"_segmentPower":0}, evalParamFrame(p, ev(0,0,1), 1))
  assert(1, evalParamFrame(p, ev(0,0,1), 2))

  p = parseExpression("2000*[[1,0,1,0,1]e@s,0]e@s")
  ...
  p = parseExpression("2000*[[1,0,1]e1/2@s:4,0]e@s")
  ...
  assert({"value":1,"_nextSegment":1,"_segmentPower":1}, evalParamFrameWithInterval(parseExpression('[1,0]e1@s'), ev(0,0,1),0))
  ...
  evalParamFrame(parseExpression("idnode>>{idnode,idnode}"), evd(),0, {expandingChords:true})
  evalParamFrame(parseExpression("{idnode,idnode}>>idnode"), evd(),0, {expandingChords:true})
  evalParamFrame(parseExpression("{idnode,idnode}>>{idnode,idnode}"), evd(),0, {expandingChords:true})
  ...
  assert(5, evalParamFrame(parseExpression('const{5} >> mockaudionode'), evd(), 0).l.offset.value)
