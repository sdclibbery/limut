...
define(function(require) {
  ...
  assert(timevar([step(none,0,4),step(none,4,4)]), parseExpression('[,]t'))
  assert(timevar([step(num(1),0,4),step(none,4,4)]), parseExpression('[1,]t'))
  assert(timevar([step(none,0,4),step(num(1),4,4)]), parseExpression('[,1]t'))
  assert(timevar([step(num(1),0,4)]), parseExpression('[1]t'))
  assert(timevar([step(none,0,4)]), parseExpression('[]t[,]'))
  assert(timevar([step(none,0,1)]), parseExpression('[]t[1,]'))
  ...
  assert(timevar([step(num(1),0,4),step(num(2),4,4)]), parseExpression('[1,2]t[]'))
  assert(timevar([step(num(1),0,4),step(num(2),4,4)]), parseExpression('[1:2]t'))
  assert(timevar([step(num(2),0,4),step(num(3),4,4),step(num(4),8,4)]), parseExpression('[2:4]t'))
  assert(timevar([step(num(1),0,4),step(none,4,4)]), parseExpression('[1:]t'))
  assert(timevar([step(none,0,4),step(num(1),4,4)]), parseExpression('[:1]t'))
  assert(timevar([step(none,0,4),step(none,4,4)]), parseExpression('[:]t'))
  assert(timevar([step(num(1),0,4),step(timevar([step(num(2),0,1),step(num(3),1,1)]),4,4)]), parseExpression('[1:[2,3]t1]t'))
