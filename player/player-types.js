...
define((require) => {
  ...
  let playerTypes = {
    ...
    // audio
    bus: { create: bus, baseParams:{ vel:3/4, amp:parseExpression('this.vel') }, _type:'audio' },
    drums: { play: play, baseParams:{ vel:3/4, amp:parseExpression('this.vel'), delay:0, dur:1/2 }, _type:'audio' },
    io808: { play: io808, baseParams:{ vel:3/4, amp:parseExpression('this.vel'), delay:0, dur:1/4 }, _type:'audio' },
    play: { play: play, baseParams:{ vel:3/4, amp:parseExpression('this.vel'), delay:0, dur:1/2, rate:1 }, _type:'audio' },
    ...
    impulse: { play: impulse, baseParams:{ vel:3/4, amp:parseExpression('this.vel'), delay:0 }, _type:'audio' },
