...
define((require) => {
  ...
  assert({value:-1,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),0))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1))
  assert({value:1/2,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1.5))
  assert({value:1,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),2))
  assert({value:2,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),3))
  p.play(p.getEventsForBeat({time:2, count:2, duration:1}))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(2)[0].x,ev(2,2,1),2))

  p = player('p', 'test', '0', 'x=time')
  p.play(p.getEventsForBeat({time:1, count:1, duration:1}))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),0))
  assert({value:1,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1))
  assert({value:3/2,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1.5))
  assert({value:2,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),2))
  assert({value:3,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),3))
  p.play(p.getEventsForBeat({time:2, count:2, duration:1}))
  assert({value:2,_units:'b'}, evalParamFrame(p.currentEvent(2)[0].x,ev(2,2,1),2))

  p = player('p', 'test', '0', 'x=time{per:1}')
  p.play(p.getEventsForBeat({time:1, count:1, duration:1}))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),0))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),2))

  p = player('p', 'test', '0', 'x=this.time{per:1/2}')
  p.play(p.getEventsForBeat({time:1, count:1, duration:1}))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1))
  assert({value:0.25,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1.25))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,ev(1,1,1),1.5))
  ...
  p = player('p', 'test', '0', 'x=(this.time){per:1/2}')
  p.play(p.getEventsForBeat({time:1, count:1, duration:1}))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,p.currentEvent(1)[0],1))
  assert({value:0.25,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,p.currentEvent(1)[0],1.25))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,p.currentEvent(1)[0],1.5))

  p = player('p', 'test', '0', 'x=this.(time,foo), foo=3')
  p.play(p.getEventsForBeat({time:1, count:1, duration:1}))
  assert({value:0,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,p.currentEvent(1)[0],1))
  assert(3, evalParamFrame(p.currentEvent(1)[1].x,p.currentEvent(1)[1],1))
  assert({value:1,_units:'b'}, evalParamFrame(p.currentEvent(1)[0].x,p.currentEvent(1)[0],2))
