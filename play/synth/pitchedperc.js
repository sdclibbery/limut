...
define(function (require) {
  ...
  let body = (params, p, def) => {
    ...
    let freq = evalSubParamEvent(params, p, 'freq', 55, 'hz')
    let boost = evalSubParamEvent(params, p, 'boost', 150, 'hz')
  ...
  let rattle = (params) => {
    ...
    let freq = evalSubParamEvent(params, 'rattle', 'freq', 55, 'hz')
    let boost = evalSubParamEvent(params, 'rattle', 'boost', 205, 'hz')
