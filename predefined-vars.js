...
define(function(require) {
  ...
  vars['fullscreen'] = parseExpression('{x:-1,y:-1,w:2,h:2}')
  vars['tile_full'] = parseExpression('{x:-1,y:-1,w:2,h:2}')
  vars['tile_tl'] = parseExpression('{x:-1,y:0,w:1,h:1}')
  vars['tile_tr'] = parseExpression('{x:0,y:0,w:1,h:1}')
  vars['tile_bl'] = parseExpression('{x:-1,y:-1,w:1,h:1}')
  vars['tile_br'] = parseExpression('{x:0,y:-1,w:1,h:1}')
  vars['tile_t'] = parseExpression('{x:-1,y:0,w:2,h:1}')
  vars['tile_b'] = parseExpression('{x:-1,y:-1,w:2,h:1}')
  vars['tile_l'] = parseExpression('{x:-1,y:-1,w:1,h:2}')
  vars['tile_r'] = parseExpression('{x:0,y:-1,w:1,h:2}')
  vars['tile_m'] = parseExpression('{x:-1/2,y:-1/2,w:1,h:1}')
  vars['tile_h1'] = parseExpression('{x:-1,y:1/2,w:2,h:1/2}')
  vars['tile_h2'] = parseExpression('{x:-1,y:0/2,w:2,h:1/2}')
  vars['tile_h3'] = parseExpression('{x:-1,y:-1/2,w:2,h:1/2}')
  vars['tile_h4'] = parseExpression('{x:-1,y:-2/2,w:2,h:1/2}')
  vars['tile_v1'] = parseExpression('{x:-2/2,y:-1,w:1/2,h:2}')
  vars['tile_v2'] = parseExpression('{x:-1/2,y:-1,w:1/2,h:2}')
  vars['tile_v3'] = parseExpression('{x:0/2,y:-1,w:1/2,h:2}')
  vars['tile_v4'] = parseExpression('{x:1/2,y:-1,w:1/2,h:2}')
  vars['tile_random'] = parseExpression('{x:[-1:1/2]r,y:[-1:1/2]r,w:1/2,h:1/2}')
  vars['tile_rand'] = parseExpression('{x:[-1:1/2]r,y:[-1:1/2]r,w:1/2,h:1/2}')
  vars['sparkle'] = parseExpression('{x:[-1:2/3]r@e,y:[-1:2/3]r@e,w:1/3,h:1/3}')
  vars['droplet'] = parseExpression('{w:1/4,h:1/4,x:[-1:3/4]r,y:[0.8:1.2]r-[0:2]e}')
